...
// Date objects:the Date() constructor creates Date objects. when called as a function, it returns a string represting the current time.
...
const date1=new Date(2025,3);
// console.log(date1);

//? 4: new Date(year, month, day): Creates a Date object with the specified year, month, and day.
const date2 = new Date(2024, 1, 33);
// console.log(date2);      //in javascript months starts with 0 to 11
...
const addDaysToDate=(date,extra)=>{
let updatedDate=date.setDate(date.getDate()+extra)
